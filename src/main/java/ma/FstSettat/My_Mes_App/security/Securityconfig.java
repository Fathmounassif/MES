package ma.FstSettat.My_Mes_App.security;


import ma.FstSettat.My_Mes_App.security.sevice.UserDetailsServiceImpl;
...
//noop:ne changer pas le mode passe(hachage).*/
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/magasinier/**").hasAuthority("MAGASINIER");
        http.authorizeRequests().antMatchers("/recepensable_qualite/**").hasAnyAuthority("RECEPENSABL_QAUALITE","MAGASINIER");
        http.authorizeRequests().antMatchers("/controle_qualite/**").hasAuthority("CONTROLE_QAUALITE");
